...
pictures of the Calypso (\textbf{Cousteau1963?}).
...
for you). This chapter, (\textbf{sec:intro?}), shows how to use
citations and how to reference section headers.
(\textbf{sec:lit-review?}) shows how use and reference equations.
(\textbf{sec:research-code?}) shows how to use and reference code.
(\textbf{sec:research-figure?}) shows how to use, reference, and resize
pdf and jpg figures. (\textbf{sec:research-table?}) shows how to use and
reference tables. (\textbf{sec:research-final?}) is truly revolutionary
(but shows nothing functional).
\textbf{\hyperref[appendix-1-some-extra-stuff]{Appendix 1}} shows how to
add chapters which are not numbered, and has to be referenced manually,
as does \textbf{\hyperref[appendix-2-some-more-extra-stuff]{Appendix
2}}. See the base
...
Later on in the text, you can reference (\textbf{eq:my\_equation?}) and
its mind-blowing ramifications. Pellentesque habitant morbi tristique
...
(\textbf{eq:my\_complicated\_equation?}) shows that you can fall back on
...
\subsection{Subsection 1 with example code block}\label{sec:subsec-code}
...
You can then reference the code block like this ((\textbf{lst:code?})).

\subsection{Subsection 2}\label{subsection-2}

By running the code in (\textbf{sec:subsec-code?}), we solved AI
...
(\textbf{fig:my\_fig?}) shows how to add a figure. Donec ut lacinia
...
\begin{figure}
\centering
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{source/figures/example_figure.pdf}
...
\begin{figure}
\centering
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{source/figures/full_caption_example.jpg}
...
(\textbf{tbl:random?}) shows us how to add a table. Integer tincidunt
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1529}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1529}}@{}}
\caption[Table short caption]{Important data for various land masses.
...
This is the discussion. As we saw in (\textbf{tbl:random?}), many things
